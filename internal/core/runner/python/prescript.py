...
lib.AgentBaseSeccomp.argtypes = [ctypes.c_uint32, ctypes.c_uint32, ctypes.c_bool]
lib.AgentBaseSeccomp.restype = None
...
lib.AgentBaseSeccomp({{uid}}, {{gid}}, {{enable_network}})
