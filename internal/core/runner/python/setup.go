...
import (
	...
	python_dependencies "github.com/agent-base/agentbase-sandbox/internal/core/runner/python/dependencies"
...
func InstallDependencies(requirements string) error {
	...
	return runner.WithTempDir("/", []string{}, func(root_path string) error {
		...
		pipMirrorURL := static.GetAgentBaseSandboxGlobalConfigurations().PythonPipMirrorURL
